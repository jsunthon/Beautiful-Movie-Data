...
public class MongoUtilities {
	...
	public MongoUtilities(String database, String collection) {
	...
	public void printDocuments() {
		...
		try (MongoCursor<Document> cursor = collection.find().iterator()) {
			while (cursor.hasNext()) {
				System.out.println(String.format("Got document %s", cursor.next().toJson()));
			}
		}
	}

	/**
	 * @return the collection of mongo documents
	 */
